...
setup(
    ...
    ext_modules=[
        ...
        Extension('gensim.models.word2vec_inner_ngram',
            sources=['./gensim/models/word2vec_inner_ngram.c'],
            include_dirs=[model_dir]),
        Extension('gensim.models.fasttext_inner_ngram',
            sources=['./gensim/models/fasttext_inner_ngram.c'],
            include_dirs=[model_dir]),
